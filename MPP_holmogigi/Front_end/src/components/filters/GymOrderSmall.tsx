...
export const GymOrderSmall = () => {
	...
	function fetchBodybuilders(page: number): Promise<Gym[]> {
		return fetch(`${BACKEND_API_URL}/api/Gym/MinCoachAge/${page}/${pageSize}`).then((response) => response.json());
	}
	...
	*/
	...
	return (
		<Container>
			<h1>Gyms ordered by the youngest coaches in them</h1>
