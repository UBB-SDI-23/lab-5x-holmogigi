...
export const GymMinAge = () => {
	...
	function fetchBodybuilders(page: number): Promise<Gym[]> {
		return fetch(`${BACKEND_API_URL}/api/Gym/order/${page}/${pageSize}`).then((response) => response.json());
	}
	...
	*/
	...
	return (
		<Container>
			<h1>Gyms ordered by the average age of the coaches</h1>
